...
// Condition types for the compute control plane. Data-plane processes do not
// write these shared project objects.
const (
	...
	// ConditionReady is reserved for aggregated Service and ServiceRevision
	// readiness. No production writer sets it until per-node readiness reporting
	// is available. Consumers must treat its absence as unreported readiness.
