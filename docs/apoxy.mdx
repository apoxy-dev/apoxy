...
* [apoxy compute](#apoxy-compute)	 - Manage compute objects
...
```
      --health-addr string     Listen address for health endpoint (e.g. ":8080"). Empty disables. In interactive sessions the endpoint is off unless this flag is set explicitly. (default "localhost:8080")
  -h, --help                   help for run
...
* [apoxy](#apoxy)	 - Open-source edge platform built on Envoy, Kubernetes APIs, and QUIC tunneling.
* [apoxy compute service](#apoxy-compute-service)	 - Manage compute Service objects
* [apoxy compute servicerevisions](#apoxy-compute-servicerevisions)	 - List ServiceRevision objects
...
* [apoxy compute](#apoxy-compute)	 - Manage compute objects
* [apoxy compute service apply](#apoxy-compute-service-apply)	 - Apply service configuration using server-side apply
* [apoxy compute service create](#apoxy-compute-service-create)	 - Create service objects
* [apoxy compute service delete](#apoxy-compute-service-delete)	 - Delete service objects
* [apoxy compute service get](#apoxy-compute-service-get)	 - Get service objects
* [apoxy compute service list](#apoxy-compute-service-list)	 - List service objects
* [apoxy compute service versions](#apoxy-compute-service-versions)	 - List ServiceRevision objects
...
* [apoxy compute service](#apoxy-compute-service)	 - Manage compute Service objects
* [apoxy compute service versions get](#apoxy-compute-service-versions-get)	 - Get servicerevision objects
* [apoxy compute service versions list](#apoxy-compute-service-versions-list)	 - List a Service's revisions
...
* [apoxy compute](#apoxy-compute)	 - Manage compute objects
* [apoxy compute servicerevisions get](#apoxy-compute-servicerevisions-get)	 - Get servicerevision objects
* [apoxy compute servicerevisions list](#apoxy-compute-servicerevisions-list)	 - List servicerevision objects
...
* [apoxy](#apoxy)	 - Open-source edge platform built on Envoy, Kubernetes APIs, and QUIC tunneling.
* [apoxy vpc egressgateway](#apoxy-vpc-egressgateway)	 - Manage EgressGateway objects
* [apoxy vpc egressroute](#apoxy-vpc-egressroute)	 - Manage EgressRoute objects
...
* [apoxy vpc](#apoxy-vpc)	 - Manage VPC networking objects
* [apoxy vpc egressgateway apply](#apoxy-vpc-egressgateway-apply)	 - Apply egressgateway configuration using server-side apply
* [apoxy vpc egressgateway create](#apoxy-vpc-egressgateway-create)	 - Create egressgateway objects
* [apoxy vpc egressgateway delete](#apoxy-vpc-egressgateway-delete)	 - Delete egressgateway objects
* [apoxy vpc egressgateway get](#apoxy-vpc-egressgateway-get)	 - Get egressgateway objects
* [apoxy vpc egressgateway list](#apoxy-vpc-egressgateway-list)	 - List egressgateway objects
...
* [apoxy vpc](#apoxy-vpc)	 - Manage VPC networking objects
* [apoxy vpc egressroute apply](#apoxy-vpc-egressroute-apply)	 - Apply egressroute configuration using server-side apply
* [apoxy vpc egressroute create](#apoxy-vpc-egressroute-create)	 - Create egressroute objects
* [apoxy vpc egressroute delete](#apoxy-vpc-egressroute-delete)	 - Delete egressroute objects
* [apoxy vpc egressroute get](#apoxy-vpc-egressroute-get)	 - Get egressroute objects
* [apoxy vpc egressroute list](#apoxy-vpc-egressroute-list)	 - List egressroute objects
