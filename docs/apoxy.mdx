...
* [apoxy egressgateway](#apoxy-egressgateway)	 - Manage EgressGateway objects
* [apoxy egressroute](#apoxy-egressroute)	 - Manage EgressRoute objects
...
* [apoxy service](#apoxy-service)	 - Manage compute Service objects
...
* [apoxy vpc](#apoxy-vpc)	 - Manage VPC networking objects
...
```
  ...
  -k, --token string           The token to use for authenticating with the tunnel relays, required if not using kubernetes-based discovery.
      ...
      --vpc string             The VPC network to connect to. (default "default")
```
...
```
  ...
  -h, --help                          help for deploy
      ...
      --username string               Registry username; password comes from --password-stdin or $APOXY_REGISTRY_PASSWORD
  -y, --yes                           Skip the deploy-target confirmation prompt (required for non-interactive runs)
```
...
* [apoxy](#apoxy)	 - Open-source edge platform built on Envoy, Kubernetes APIs, and QUIC tunneling.
* [apoxy egressgateway apply](#apoxy-egressgateway-apply)	 - Apply egressgateway configuration using server-side apply
* [apoxy egressgateway create](#apoxy-egressgateway-create)	 - Create egressgateway objects
* [apoxy egressgateway delete](#apoxy-egressgateway-delete)	 - Delete egressgateway objects
* [apoxy egressgateway get](#apoxy-egressgateway-get)	 - Get egressgateway objects
* [apoxy egressgateway list](#apoxy-egressgateway-list)	 - List egressgateway objects



## apoxy egressgateway apply
...
This command uses server-side apply to create or update egressgateway objects.
Server-side apply tracks field ownership and allows multiple actors to
manage different fields of the same object without conflicts.

```
apoxy egressgateway apply [-f filename] [flags]
```
...
```
apoxy egressgateway create [-f filename] [flags]
```
...
## apoxy egressgateway delete

Delete egressgateway objects

```
apoxy egressgateway delete [flags]
```
...
## apoxy egressgateway get

Get egressgateway objects

```
apoxy egressgateway get <name> [flags]
```
...
## apoxy egressgateway list

List egressgateway objects

```
apoxy egressgateway list [flags]
```
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the egressgateway's labels.
```
...
* [apoxy](#apoxy)	 - Open-source edge platform built on Envoy, Kubernetes APIs, and QUIC tunneling.
* [apoxy egressroute apply](#apoxy-egressroute-apply)	 - Apply egressroute configuration using server-side apply
* [apoxy egressroute create](#apoxy-egressroute-create)	 - Create egressroute objects
* [apoxy egressroute delete](#apoxy-egressroute-delete)	 - Delete egressroute objects
* [apoxy egressroute get](#apoxy-egressroute-get)	 - Get egressroute objects
* [apoxy egressroute list](#apoxy-egressroute-list)	 - List egressroute objects



## apoxy egressroute apply
...
This command uses server-side apply to create or update egressroute objects.
Server-side apply tracks field ownership and allows multiple actors to
manage different fields of the same object without conflicts.

```
apoxy egressroute apply [-f filename] [flags]
```
...
```
apoxy egressroute create [-f filename] [flags]
```
...
## apoxy egressroute delete

Delete egressroute objects

```
apoxy egressroute delete [flags]
```
...
## apoxy egressroute get

Get egressroute objects

```
apoxy egressroute get <name> [flags]
```
...
## apoxy egressroute list

List egressroute objects

```
apoxy egressroute list [flags]
```
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the egressroute's labels.
```
...
* [apoxy](#apoxy)	 - Open-source edge platform built on Envoy, Kubernetes APIs, and QUIC tunneling.
* [apoxy service apply](#apoxy-service-apply)	 - Apply service configuration using server-side apply
* [apoxy service create](#apoxy-service-create)	 - Create service objects
* [apoxy service delete](#apoxy-service-delete)	 - Delete service objects
* [apoxy service get](#apoxy-service-get)	 - Get service objects
* [apoxy service list](#apoxy-service-list)	 - List service objects
* [apoxy service versions](#apoxy-service-versions)	 - List ServiceRevision objects
...
This command uses server-side apply to create or update service objects.
Server-side apply tracks field ownership and allows multiple actors to
manage different fields of the same object without conflicts.

```
apoxy service apply [-f filename] [flags]
```
...
```
apoxy service create [-f filename] [flags]
```
...
## apoxy service delete

Delete service objects

```
apoxy service delete [flags]
```
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the service's labels.
```
...
compute.apoxy.dev/service label. Omit it to list every revision in the
...
```
apoxy service versions [name] [flags]
```
...
* [apoxy service](#apoxy-service)	 - Manage compute Service objects
* [apoxy service versions get](#apoxy-service-versions-get)	 - Get servicerevision objects
* [apoxy service versions list](#apoxy-service-versions-list)	 - List a Service's revisions



## apoxy service versions get

Get servicerevision objects

```
apoxy service versions get <name> [flags]
```
...
```
apoxy service versions list [name] [flags]
```
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the servicerevision's labels.
```
...
* [apoxy](#apoxy)	 - Open-source edge platform built on Envoy, Kubernetes APIs, and QUIC tunneling.
* [apoxy vpc network](#apoxy-vpc-network)	 - Manage VPC networks
* [apoxy vpc relay](#apoxy-vpc-relay)	 - Inspect relays
* [apoxy vpc service](#apoxy-vpc-service)	 - Manage VPC services
* [apoxy vpc tunnel](#apoxy-vpc-tunnel)	 - Inspect tunnels
...
* [apoxy vpc](#apoxy-vpc)	 - Manage VPC networking objects
* [apoxy vpc network apply](#apoxy-vpc-network-apply)	 - Apply vpcnetwork configuration using server-side apply
* [apoxy vpc network create](#apoxy-vpc-network-create)	 - Create vpcnetwork objects
* [apoxy vpc network delete](#apoxy-vpc-network-delete)	 - Delete vpcnetwork objects
* [apoxy vpc network get](#apoxy-vpc-network-get)	 - Get vpcnetwork objects
* [apoxy vpc network list](#apoxy-vpc-network-list)	 - List vpcnetwork objects
...
This command uses server-side apply to create or update vpcnetwork objects.
Server-side apply tracks field ownership and allows multiple actors to
manage different fields of the same object without conflicts.
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the vpcnetwork's labels.
```
...
* [apoxy vpc](#apoxy-vpc)	 - Manage VPC networking objects
* [apoxy vpc relay get](#apoxy-vpc-relay-get)	 - Get relay objects
* [apoxy vpc relay list](#apoxy-vpc-relay-list)	 - List relay objects
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the relay's labels.
```
...
* [apoxy vpc](#apoxy-vpc)	 - Manage VPC networking objects
* [apoxy vpc service apply](#apoxy-vpc-service-apply)	 - Apply vpcservice configuration using server-side apply
* [apoxy vpc service create](#apoxy-vpc-service-create)	 - Create vpcservice objects
* [apoxy vpc service delete](#apoxy-vpc-service-delete)	 - Delete vpcservice objects
* [apoxy vpc service get](#apoxy-vpc-service-get)	 - Get vpcservice objects
* [apoxy vpc service list](#apoxy-vpc-service-list)	 - List vpcservice objects
...
This command uses server-side apply to create or update vpcservice objects.
Server-side apply tracks field ownership and allows multiple actors to
manage different fields of the same object without conflicts.
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the vpcservice's labels.
```
...
* [apoxy vpc](#apoxy-vpc)	 - Manage VPC networking objects
* [apoxy vpc tunnel get](#apoxy-vpc-tunnel-get)	 - Get tunnel objects
* [apoxy vpc tunnel list](#apoxy-vpc-tunnel-list)	 - List tunnel objects
...
```
  ...
  -h, --help                    help for list
  -o, --output string           Output format: "json" or "yaml". Default is table.
      --show-labels             Print the tunnel's labels.
```
