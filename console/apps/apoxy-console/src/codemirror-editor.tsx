...
// highlighting and a lint gutter (parse errors). It's browser-only — CodeMirror
// can't render in jsdom — so it lives in the app and is installed once via
// <TrayEditorProvider>; tests and SSR fall back to the textarea.
//
...
import type { TrayEditorProps } from '@apoxy/console-core'
...
export function CodeMirrorEditor({ value, onChange, readOnly, ariaLabel = 'YAML editor' }: TrayEditorProps) {
