...
type BuildInformer interface {
	...
	Lister() computev1alpha1.BuildLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ComputeV1alpha1().Builds().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ComputeV1alpha1().Builds().Watch(context.TODO(), options)
			},
		},
		&apicomputev1alpha1.Build{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *buildInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apicomputev1alpha1.Build{}, f.defaultInformer)
}

func (f *buildInformer) Lister() computev1alpha1.BuildLister {
	return computev1alpha1.NewBuildLister(f.Informer().GetIndexer())
}
