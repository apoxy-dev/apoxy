...
type ServiceInformer interface {
	...
	Lister() computev1alpha1.ServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ComputeV1alpha1().Services().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ComputeV1alpha1().Services().Watch(context.TODO(), options)
			},
		},
		&apicomputev1alpha1.Service{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apicomputev1alpha1.Service{}, f.defaultInformer)
}

func (f *serviceInformer) Lister() computev1alpha1.ServiceLister {
	return computev1alpha1.NewServiceLister(f.Informer().GetIndexer())
}
