...
type Interface interface {
	...
	ServiceRevisions() ServiceRevisionInformer
}
...
// ServiceRevisions returns a ServiceRevisionInformer.
func (v *version) ServiceRevisions() ServiceRevisionInformer {
	return &serviceRevisionInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
