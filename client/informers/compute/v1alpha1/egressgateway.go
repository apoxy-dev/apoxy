...
type EgressGatewayInformer interface {
	...
	Lister() computev1alpha1.EgressGatewayLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ComputeV1alpha1().EgressGateways().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ComputeV1alpha1().EgressGateways().Watch(context.TODO(), options)
			},
		},
		&apicomputev1alpha1.EgressGateway{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *egressGatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apicomputev1alpha1.EgressGateway{}, f.defaultInformer)
}

func (f *egressGatewayInformer) Lister() computev1alpha1.EgressGatewayLister {
	return computev1alpha1.NewEgressGatewayLister(f.Informer().GetIndexer())
}
