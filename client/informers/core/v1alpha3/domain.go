...
type DomainInformer interface {
	...
	Lister() corev1alpha3.DomainLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha3().Domains().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha3().Domains().Watch(context.TODO(), options)
			},
		},
		&apicorev1alpha3.Domain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *domainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apicorev1alpha3.Domain{}, f.defaultInformer)
}

func (f *domainInformer) Lister() corev1alpha3.DomainLister {
	return corev1alpha3.NewDomainLister(f.Informer().GetIndexer())
}
