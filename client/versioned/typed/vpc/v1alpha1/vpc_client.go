...
// VpcV1alpha1Client is used to interact with features provided by the vpc.apoxy.dev group.
type VpcV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VpcV1alpha1Client) Relays() RelayInterface {
	return newRelays(c)
}

func (c *VpcV1alpha1Client) Tunnels() TunnelInterface {
	return newTunnels(c)
}

func (c *VpcV1alpha1Client) VPCNetworks() VPCNetworkInterface {
	return newVPCNetworks(c)
}

func (c *VpcV1alpha1Client) VPCServices() VPCServiceInterface {
	return newVPCServices(c)
}
...
// NewForConfigAndClient creates a new VpcV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*VpcV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
