...
// GatewayV1alpha2Client is used to interact with features provided by the gateway.apoxy.dev group.
type GatewayV1alpha2Client struct {
	restClient rest.Interface
}

func (c *GatewayV1alpha2Client) TCPRoutes() TCPRouteInterface {
	return newTCPRoutes(c)
}

func (c *GatewayV1alpha2Client) TLSRoutes() TLSRouteInterface {
	return newTLSRoutes(c)
}

func (c *GatewayV1alpha2Client) UDPRoutes() UDPRouteInterface {
	return newUDPRoutes(c)
}
