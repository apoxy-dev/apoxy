...
type edgeFunctions struct {
	*gentype.ClientWithList[*extensionsv1alpha2.EdgeFunction, *extensionsv1alpha2.EdgeFunctionList]
}

// newEdgeFunctions returns a EdgeFunctions
func newEdgeFunctions(c *ExtensionsV1alpha2Client) *edgeFunctions {
	return &edgeFunctions{
		gentype.NewClientWithList[*extensionsv1alpha2.EdgeFunction, *extensionsv1alpha2.EdgeFunctionList](
			"edgefunctions",
			c.RESTClient(),
			scheme.ParameterCodec,
			"",
			func() *extensionsv1alpha2.EdgeFunction { return &extensionsv1alpha2.EdgeFunction{} },
			func() *extensionsv1alpha2.EdgeFunctionList { return &extensionsv1alpha2.EdgeFunctionList{} },
		),
	}
}
