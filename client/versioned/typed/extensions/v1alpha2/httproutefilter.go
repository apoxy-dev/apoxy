...
type hTTPRouteFilters struct {
	*gentype.ClientWithList[*extensionsv1alpha2.HTTPRouteFilter, *extensionsv1alpha2.HTTPRouteFilterList]
}

// newHTTPRouteFilters returns a HTTPRouteFilters
func newHTTPRouteFilters(c *ExtensionsV1alpha2Client) *hTTPRouteFilters {
	return &hTTPRouteFilters{
		gentype.NewClientWithList[*extensionsv1alpha2.HTTPRouteFilter, *extensionsv1alpha2.HTTPRouteFilterList](
			"httproutefilters",
			c.RESTClient(),
			scheme.ParameterCodec,
			"",
			func() *extensionsv1alpha2.HTTPRouteFilter { return &extensionsv1alpha2.HTTPRouteFilter{} },
			func() *extensionsv1alpha2.HTTPRouteFilterList { return &extensionsv1alpha2.HTTPRouteFilterList{} },
		),
	}
}
