...
// MetricsV1alpha1Client is used to interact with features provided by the metrics.apoxy.dev group.
type MetricsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MetricsV1alpha1Client) Metrics() MetricInterface {
	return newMetrics(c)
}

func (c *MetricsV1alpha1Client) MetricSources() MetricSourceInterface {
	return newMetricSources(c)
}
