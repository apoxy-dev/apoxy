...
func (c *FakeBackends) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Backend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(backendsResource, name), &v1alpha2.Backend{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeBackends) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.BackendList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(backendsResource, backendsKind, opts), &v1alpha2.BackendList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeBackends) Create(ctx context.Context, backend *v1alpha2.Backend, opts v1.CreateOptions) (result *v1alpha2.Backend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(backendsResource, backend), &v1alpha2.Backend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.Backend), err
...
func (c *FakeBackends) Update(ctx context.Context, backend *v1alpha2.Backend, opts v1.UpdateOptions) (result *v1alpha2.Backend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(backendsResource, backend), &v1alpha2.Backend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.Backend), err
...
func (c *FakeBackends) UpdateStatus(ctx context.Context, backend *v1alpha2.Backend, opts v1.UpdateOptions) (*v1alpha2.Backend, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(backendsResource, "status", backend), &v1alpha2.Backend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.Backend), err
...
func (c *FakeBackends) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(backendsResource, name, opts), &v1alpha2.Backend{})
	return err
}
...
func (c *FakeBackends) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Backend, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(backendsResource, name, pt, data, subresources...), &v1alpha2.Backend{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.Backend), err
