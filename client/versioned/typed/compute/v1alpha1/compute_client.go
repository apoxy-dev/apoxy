...
// ComputeV1alpha1Client is used to interact with features provided by the compute.apoxy.dev group.
...
func (c *ComputeV1alpha1Client) ServiceRevisions() ServiceRevisionInterface {
	return newServiceRevisions(c)
}
