...
import (
	v1alpha1 "github.com/apoxy-dev/apoxy/client/versioned/typed/compute/v1alpha1"
...
func (c *FakeComputeV1alpha1) Builds() v1alpha1.BuildInterface {
...
func (c *FakeComputeV1alpha1) ServiceRevisions() v1alpha1.ServiceRevisionInterface {
	return newFakeServiceRevisions(c)
}
