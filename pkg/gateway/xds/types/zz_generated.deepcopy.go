...
func (in *NodeEnvoyExit) DeepCopyInto(out *NodeEnvoyExit) {
	*out = *in
	in.At.DeepCopyInto(&out.At)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeEnvoyExit.
func (in *NodeEnvoyExit) DeepCopy() *NodeEnvoyExit {
	if in == nil {
		return nil
	}
	out := new(NodeEnvoyExit)
	in.DeepCopyInto(out)
	return out
}
